      ...
      <div className="hidden lg:flex lg:w-[45%] xl:w-[42%] relative overflow-hidden flex-col justify-between p-10 bg-gradient-to-br from-primary via-primary/90 to-primary/70 rounded-r-[2.5rem]">
        <div>
          <h2 className="text-2xl font-black text-primary-foreground tracking-tight">
            Fin<span className="opacity-80">Track</span>
          </h2>
        </div>
        ...
        <div className="space-y-6">
          ...
          <p className="text-primary-foreground/80 text-lg max-w-sm">
            Track expenses, manage budgets, and grow your wealth — all in one place.
          </p>
        </div>
        ...
        <div className="bg-primary-foreground/10 backdrop-blur-sm rounded-2xl p-5 max-w-md">
          <p className="text-primary-foreground/90 text-sm leading-relaxed italic">
            "FinTrack completely changed how I manage money. I can see exactly where every dollar goes and plan ahead with confidence."
          </p>
          <div className="mt-3 flex items-center gap-3">
            ...
            <div>
              <p className="text-primary-foreground text-sm font-semibold">Jane Doe</p>
              <p className="text-primary-foreground/60 text-xs">Freelancer</p>
            </div>
          </div>
        </div>
      </div>
